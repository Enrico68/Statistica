...
\urlstyle{same}
\hypersetup{
  pdftitle={A Tufte Handout Example},
  pdfauthor={JJ Allaire and Yihui Xie},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{A Tufte Handout Example}
\usepackage{etoolbox}
\makeatletter
...
Allaire et al. (\citeproc{ref-R-rmarkdown}{2023}) for more information
about \textbf{rmarkdown}.
...
\begin{figure}
\centering
\includegraphics{Tufte_files/figure-latex/fig-margin-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Tufte_files/figure-latex/fig-fullwidth-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Tufte_files/figure-latex/fig-main-1.pdf}
...
example, we can cite R here (\citeproc{ref-R-base}{R Core Team 2023}).
To enable this feature, you must set \texttt{link-citations:\ yes} in
the YAML metadata, and the version of Pandoc should at least 2.11 or
\texttt{pandoc-citeproc} should be available and at least 0.7.2. You can
...
\includegraphics{Tufte_files/figure-latex/fig-two-together-1.pdf}
\includegraphics{Tufte_files/figure-latex/fig-two-together-2.pdf}
...
\begin{figure}
\centering
\includegraphics{Tufte_files/figure-latex/fig-two-separate-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Tufte_files/figure-latex/fig-two-separate-2.pdf}
...
\includegraphics{Tufte_files/figure-latex/fig-margin-together-1.pdf}
\includegraphics{Tufte_files/figure-latex/fig-margin-together-2.pdf}
...
\begin{figure}
\centering
\includegraphics{Tufte_files/figure-latex/fig-margin-separate-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Tufte_files/figure-latex/fig-margin-separate-2.pdf}
\caption{Two plots in separate figure environments in the margin (the
second plot).}
\end{figure}
...
\includegraphics{Tufte_files/figure-latex/fig-nocap-margin-1.pdf}
...
\includegraphics{Tufte_files/figure-latex/fig-nocap-main-1.pdf}
...
\includegraphics{Tufte_files/figure-latex/fig-nocap-fullwidth-1.pdf}
