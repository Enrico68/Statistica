...
```{r fig-margin, fig.margin = TRUE, fig.cap = "MPG vs cavalli potenza, colored by transmission.", fig.width=3.5, fig.height=3.5, cache=TRUE, message=FALSE}
library(ggplot2)
mtcars2 <- mtcars
mtcars2$am <- factor(
