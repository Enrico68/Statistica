...
@R-rmarkdown for more information about \textbf{rmarkdown}.
...
do not hesitate to file them to https://github.com/rstudio/tufte/issues.
...
{In his later books}\footnote{\href{https://www.edwardtufte.com/tufte/books_be}{Beautiful
...
\begin{figure}
\centering
\includegraphics{figure/fig-margin-1.png}
...
\begin{figure}
\centering
\includegraphics{figure/fig-fullwidth-1.png}
...
\begin{figure}
\centering
\includegraphics{figure/fig-main-1.png}
\caption{A figure in the main column.}
\end{figure}
...
expression. ⊕{This is a margin note. Notice that there is no number
...
anything in Markdown syntax, please use the \texttt{marginfigure} block
described previously.

\section{References}\label{references}

References can be displayed as margin notes for HTML output. For
example, we can cite R here {[}@R-base{]}. To enable this feature, you
...
version of Pandoc from https://pandoc.org/installing.html if the version
is not sufficient. To check the version of \texttt{pandoc-citeproc} in
...
\includegraphics{figure/fig-two-together-1.png}\includegraphics{figure/fig-two-together-2.png}
...
\begin{figure}
\centering
\includegraphics{figure/fig-two-separate-1.png}
\caption{Two plots in separate figure environments (the first plot).}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/fig-two-separate-2.png}
\caption{Two plots in separate figure environments (the second plot).}
\end{figure}
...
\includegraphics{figure/fig-margin-together-1.png}\includegraphics{figure/fig-margin-together-2.png}
...
\begin{figure}
\centering
\includegraphics{figure/fig-margin-separate-1.png}
\caption{Two plots in separate figure environments in the margin (the
first plot).}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/fig-margin-separate-2.png}
\caption{Two plots in separate figure environments in the margin (the
second plot).}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/fig-nocap-margin-1.png}
\caption{plot of chunk fig-nocap-margin}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/fig-nocap-main-1.png}
\caption{plot of chunk fig-nocap-main}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/fig-nocap-fullwidth-1.png}
\caption{plot of chunk fig-nocap-fullwidth}
\end{figure}
...
far. If you prefer {sans-serif fonts}, use the function
...
\NormalTok{h3}\FunctionTok{.subtitle}\NormalTok{ em \{}
  \KeywordTok{font{-}style}\CharTok{:} \DecValTok{normal}\OperatorTok{;}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
