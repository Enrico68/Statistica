...
data = {"age": [25, 30, 35, 40], "gender": ["Male", "Female", "Male", "Female"]}
...
dataset = pd.DataFrame(
    {
        "walking_with_dogs": [9, 7, 10, 12, 6, 8],
...
trimmed_mean_without_dogs = trim_mean(
    dataset["walking_without_dogs"], proportiontocut=0.05
)
...
x, y = np.meshgrid(np.sqrt(x**2 + y**2))
